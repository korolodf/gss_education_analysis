...
By looking at @fig-4 we can see that most respondents are "moderately satisfied" or higher with their current employment. Although each has

```{r}
#| echo: false
#| warning: false
#| label: fig-4
#| fig-cap: "Respondent's Highest Level of Education Achieved by Job Satisfaction"

#### Creating Graph to Compare Respondent's Self-Ascribed Financial Ranking Against Other US Families by Highest Level of Education Achieved ####
